...
! 	CALL CENTER_VELOCITY(NX,NY,NZ,WO,U3_TMP2,3)
	...
	CALL YFACE_VELOCITY(NX,NY,NZ,UO,U1_TMP2,1)
        CALL YFACE_VELOCITY(NX,NY,NZ,VO,U2_TMP2,2)
	CALL YFACE_VELOCITY(NX,NY,NZ,WO,U3_TMP2,3)
...
!------------------------------------ pi/2 plane--------------
        ...
        CALL WRITE_PLANE(U1_TMP2,2,(NY-2)/4+1,0,0,'U0_90deg',
     &                  .FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &			YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)

        CALL WRITE_PLANE(U2_TMP2,2,(NY-2)/4+1,0,0,'V0_90deg',
     &                  .FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &			YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)

        CALL WRITE_PLANE(U3_TMP2,2,(NY-2)/4+1,0,0,'W0_90deg',
     &                  .FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &			YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
...
!------------------------------------ 3 pi/2 plane--------------
        ...
        CALL WRITE_PLANE(U1_TMP2,2,3*(NY-2)/4+1,0,0,'U0_270deg',
     &                  .FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &			YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)

        CALL WRITE_PLANE(U2_TMP2,2,3*(NY-2)/4+1,0,0,'V0_270deg',
     &                  .FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &			YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)

        CALL WRITE_PLANE(U3_TMP2,2,3*(NY-2)/4+1,0,0,'W0_270deg',
     &                  .FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &			YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
...
!------------------------------------ 0 plane------------------
        ...
        CALL WRITE_PLANE(U1_TMP2,2,NY-1,0,0,'U0_0deg',
     &                  .FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &			YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)

        CALL WRITE_PLANE(U2_TMP2,2,NY-1,0,0,'V0_0deg',
     &                  .FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &		        YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)

        CALL WRITE_PLANE(U3_TMP2,2,NY-1,0,0,'W0_0deg',
     &                  .FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &			YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
...
!------------------------------------ pi plane------------------
        ...
        CALL WRITE_PLANE(U1_TMP2,2,(NY-2)/2+1,0,0,'U0_180deg',
     &                  .FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &			YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)

        CALL WRITE_PLANE(U2_TMP2,2,(NY-2)/2+1,0,0,'V0_180deg',
     &                  .FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &			YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)

        CALL WRITE_PLANE(U3_TMP2,2,(NY-2)/2+1,0,0,'W0_180deg',
     &                  .FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &			YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
...
!------------------------ streamwise planes  -------------------------------------
	...
	CALL CENTER_VELOCITY(NX,NY,NZ,VO,U2_TMP2,2)
        ...
        CALL WRITE_PLANE(UO,3,250,0,0,'U0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(U2_TMP2,3,250,0,0,'V0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(WO,3,250,0,0,'W0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)


        CALL WRITE_PLANE(UO,3,551,0,0,'U0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(U2_TMP2,3,551,0,0,'V0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
       CALL WRITE_PLANE(WO,3,551,0,0,'W0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)


        CALL WRITE_PLANE(UO,3,838,0,0,'U0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(U2_TMP2,3,838,0,0,'V0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
       CALL WRITE_PLANE(WO,3,838,0,0,'W0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)

        CALL WRITE_PLANE(UO,3,951,0,0,'U0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(U2_TMP2,3,951,0,0,'V0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
       CALL WRITE_PLANE(WO,3,951,0,0,'W0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)

        CALL WRITE_PLANE(UO,3,1051,0,0,'U0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(U2_TMP2,3,1051,0,0,'V0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(WO,3,1051,0,0,'W0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)

        CALL WRITE_PLANE(UO,3,1231,0,0,'U0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(U2_TMP2,3,1231,0,0,'V0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(WO,3,1231,0,0,'W0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)

        CALL WRITE_PLANE(UO,3,1263,0,0,'U0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(U2_TMP2,3,1263,0,0,'V0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(WO,3,1263,0,0,'W0',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
...
!------------------------ pressure -------------------------------------------------------------
	...
	CALL YFACE_VELOCITY(NX,NY,NZ,P,U1_TMP2,4)

        CALL WRITE_PLANE(U1_TMP2,2,(NY-2)/4+1,0,0,'P_90deg',
     &                  .FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &			YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)

        CALL WRITE_PLANE(U1_TMP2,2,3*(NY-2)/4+1,0,0,'P_270deg',
     &                  .FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &			YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)

        CALL WRITE_PLANE(U1_TMP2,2,NY-1,0,0,'P_0deg',
     &                  .FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &			YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)

        CALL WRITE_PLANE(U1_TMP2,2,(NY-2)/2+1,0,0,'P_180deg',
     &                  .FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &			YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)


        CALL WRITE_PLANE(P,3,250,0,0,'P',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(P,3,551,0,0,'P',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(P,3,838,0,0,'P',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
       CALL WRITE_PLANE(P,3,951,0,0,'P',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
       CALL WRITE_PLANE(P,3,1051,0,0,'P',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
       CALL WRITE_PLANE(P,3,1231,0,0,'P',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
       CALL WRITE_PLANE(P,3,1263,0,0,'P',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
...
!------------------------ azimuthal vorticity  --------------------------------------------------
 	...
 	CALL YFACE_VELOCITY(NX,NY,NZ,rtmp1,U1_TMP2,4)

        CALL WRITE_PLANE(U1_TMP2,2,(NY-2)/4+1,0,0,'omgt_90deg',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(U1_TMP2,2,3*(NY-2)/4+1,0,0,'omgt_270deg',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(U1_TMP2,2,NY-1,0,0,'omgt_0deg',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(U1_TMP2,2,(NY-2)/2+1,0,0,'omgt_180deg',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
...
!------------------------ total density  -------------------------------------
! not shifted in the k planes

!	CALL YFACE_VELOCITY(NX,NY,NZ,DENS,U1_TMP2,4)

!        CALL WRITE_PLANE(U1_TMP2,2,(NY-2)/4+1,0,0,'DENS_90deg',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
!     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
!        CALL WRITE_PLANE(U1_TMP2,2,3*(NY-2)/4+1,0,0,'DENS_270deg',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
!     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
!        CALL WRITE_PLANE(U1_TMP2,2,NY-1,0,0,'DENS_0deg',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
!     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
!        CALL WRITE_PLANE(U1_TMP2,2,(NY-2)/2+1,0,0,'DENS_180deg',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
!     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
!
!


        CALL WRITE_PLANE(DENS,3,250,0,0,'dens',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(DENS,3,551,0,0,'dens',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(DENS,3,838,0,0,'dens',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
       CALL WRITE_PLANE(DENS,3,951,0,0,'dens',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
       CALL WRITE_PLANE(DENS,3,1051,0,0,'dens',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
       CALL WRITE_PLANE(DENS,3,1231,0,0,'dens',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
       CALL WRITE_PLANE(DENS,3,1263,0,0,'dens',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
...
!------------------------ density fluctuation  -------------------------------------
	...
	CALL YFACE_VELOCITY(NX,NY,NZ,U3_TMP2,U1_TMP2,4)

        CALL WRITE_PLANE(U1_TMP2,2,(NY-2)/4+1,0,0,'densf_90deg',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(U1_TMP2,2,3*(NY-2)/4+1,0,0,'densf_270deg',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(U1_TMP2,2,NY-1,0,0,'densf_0deg',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(U1_TMP2,2,(NY-2)/2+1,0,0,'densf_180deg',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)


        CALL WRITE_PLANE(U3_TMP2,3,250,0,0,'densf',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(U3_TMP2,3,551,0,0,'densf',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
        CALL WRITE_PLANE(U3_TMP2,3,838,0,0,'densf',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
       CALL WRITE_PLANE(U3_TMP2,3,951,0,0,'densf',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
       CALL WRITE_PLANE(U3_TMP2,3,1051,0,0,'densf',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
       CALL WRITE_PLANE(U3_TMP2,3,1231,0,0,'densf',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
       CALL WRITE_PLANE(U3_TMP2,3,1263,0,0,'densf',.FALSE.,NX,NY,NZ,NZG,XC,XU,YC,YV,ZCG,ZWG,XC_CAR,
     &				YC_CAR,XU_CAR,YU_CAR,XV_CAR,YV_CAR,ICYCLE,TIME,DTM1,STAT)
...
!*************************************************
 ...
 !Invalid direction
	...
	return
       ...
       subroutine yface_velocity(nx,ny,nz,Uin,Ucen,dir)
	INCLUDE 'common.h'
        INCLUDE 'mpif.h'
!Passed Variables
	integer,intent(in)      :: dir,nx,ny,nz
...
!********************X1***************************
	...
	do j=1,ny-1
      	do i=2,nx-1
        Ucen(i,j,k)=0.250d0*(uin(i,j,k)+uin(i-1,j,k)+
     &                   uin(i,j+1,k)+uin(i-1,j+1,k) )
      	enddo
     	enddo
	enddo
...
! centering not required      
       ...
       do k=2,nz-1
        do j=1,ny-1
         do i=2,nx-1
       Ucen(i,j,k)=0.250d0*(uin(i,j,k)+uin(i,j,k-1)+
     &                    uin(i,j+1,k)+uin(i,j+1,k-1))
         enddo
        enddo
       enddo
        ...
        elseif (dir.EQ.4) then 
         do j=1,ny-1
          Ucen(:,j,:)=0.50d0*(uin(:,j,:)+uin(:,j+1,:))
         enddo


	else
!Invalid direction
	write(*,'(a60,i2)') "INVALID DIRECTION IN yface_velocities 
     &                      dir must be 1,2,3,4.  dir= ", dir
	endif

	return
	end subroutine yface_velocity
